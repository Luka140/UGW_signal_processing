...
if __name__ == '__main__':
    ...
    avg_signals = load_signals_SINTEG(data_sinteg, skip_idx={34, 41}, plot_outliers=False, skip_ch=[2])
    ...
    measurement = Measurement((0,0), [(100e-3,0), (100e-3, 0.)], tx_signal=avg_signals[-1], rx_signal=avg_signals[:-1], dispersion_curves=dispersion)
